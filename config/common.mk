...
PRODUCT_COPY_FILES += \
    ...
    vendor/pa/config/permissions/privapp-permissions-aospa-system-ext.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-aospa-system-ext.xml \
